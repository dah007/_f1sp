...
vi.mock('../components/ui/theme-provider.tsx', () => ({ ThemeProvider: ({ children }: any) => children }));
...
describe('main.tsx', async () => {
    it('initializes Google Analytics and renders the app', async () => {
        // Set up env var
        (import.meta as any).env = { VITE_GA_MEASUREMENT_ID: 'G-BKX0YT6DY2' };
        // Import after mocks
        ...
        const createRootResult = (ReactDOM.createRoot as any).mock.results[0].value;
